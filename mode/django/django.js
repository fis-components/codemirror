...
(function (mod) {
    ...
    module.exports = mod(require('../../lib/codemirror'), require('../htmlmixed/htmlmixed'), require('../../addon/mode/overlay')) || module.exports;;
}(function (CodeMirror) {
    'use strict';
        ...
        function inVariable(stream, state) {
            ...
            if (state.waitProperty) {
                ...
                if (stream.match(/\b(\w+)\b/)) {
                    state.waitDot = true;
                    // A property can be followed by another property
                    state.waitPipe = true;
                    // A property can be followed by a filter
                    return 'property';
                }
            }
            // Highlight filters
