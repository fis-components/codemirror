...
(function (mod) {
    ...
    CodeMirror.defineMode('nginx', function (config) {
        ...
        var keywords = words(/* ngxDirectiveControl */
        'break return rewrite set' + /* ngxDirective */
        ...
        var keywords_block = words(/* ngxDirectiveBlock */
        'http mail events server types location upstream charset_map limit_except if geo map');
        var keywords_important = words(/* ngxDirectiveImportant */
