...
(function (mod) {
    ...
    CodeMirror.defineMode('kotlin', function (config, parserConfig) {
        ...
        var keywords = words('package continue return object while break class data trait interface throw super' + ' when type this else This try val var fun for is in if do as true false null get set');
        var softKeywords = words('import' + ' where by get set abstract enum open annotation override private public internal' + ' protected catch out vararg inline finally final ref');
        ...
        return {
            ...
            token: function (stream, state) {
                ...
                if ((curPunc == ';' || curPunc == ':') && ctx.type == 'statement')
                    popContext(state);    // Handle indentation for {x -> \n ... }
