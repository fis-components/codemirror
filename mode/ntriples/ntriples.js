    ...
    CodeMirror.defineMode('ntriples', function () {
        ...
        function transitState(currState, c) {
            ...
            if (currLocation == Location.PRE_SUBJECT && c == '<')
                ...
                ret = Location.WRITING_OBJ_LITERAL;    // Closing.
                ...
                ret = Location.POST_OBJ;    // Closing typed and language literal.
            else if (currLocation == Location.WRITING_OBJ_LITERAL && c == '@')
                ret = Location.WRITING_LIT_LANG;
            else if (currLocation == Location.WRITING_OBJ_LITERAL && c == '^')
                ret = Location.WRITING_LIT_TYPE;    // Spaces.
                ...
                ret = currLocation;    // Reset.
            else if (currLocation == Location.POST_OBJ && c == '.')
                ret = Location.PRE_SUBJECT;    // Error
            else
                ret = Location.ERROR;
