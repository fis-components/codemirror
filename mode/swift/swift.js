            ...
            token: function (stream, state) {
                ...
                if (state.string) {
                    if (state.escape) {
                        ...
                        if ((ch == '"' && (state.doubleString && !state.singleString) || ch == '\'' && (!state.doubleString && state.singleString)) && !state.escape) {
                            state.string = false;
                    ...
                    if (typeof the_word != 'undefined') {
                        ...
                        if (numbers.indexOf(the_word) > -1)
                            return 'number';
                        if ((numbers.indexOf(the_word.charAt(0) + '') > -1 || operators.indexOf(the_word.charAt(0) + '') > -1) && numbers.indexOf(ch) > -1) {
                            return 'number';
                        }
