...
(function (mod) {
    ...
    def('text/x-kotlin', {
        ...
        'package as typealias class interface this super val ' + 'var fun for is in This throw return ' + 'break continue object if else while do try when !in !is as? ' + /*soft keywords*/
